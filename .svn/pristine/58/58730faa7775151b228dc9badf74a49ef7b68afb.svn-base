	...
	<div style="position:absolute;">
		...
		<form action="${pageContext.request.contextPath}/servlet/AdminServlet">
					<div>
	                    ...
	                    <p>账户名</p><input value="admin01" name="adminaccount" style="width:200px;height:34px;box-shadow:inset 0 0 8px #eaeaea; background:#fdfdfd;"type="text" placeholder="管理员账户"></input>
	                	<span class="err-msg-login">${errVo.errinfo1}</span>
	                </div>
	                <div id="err1" class="err_tip">
	                    <em class="icon_error"></em><span class="error-msg">${param.errinfo1}</span>
	                </div>
	                ...
	                <div id="err2" class="err_tip">
	                    <em class="icon_error"></em><span class="error-msg"></span>
	                </div>
	                <span>${info}</span><br/>
